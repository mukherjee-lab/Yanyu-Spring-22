...
for j in randnum:
    ...
    X_test = shuffle(X, random_state=j).iloc[2000:4000]
    y_train_full1 = shuffle(y_train_white, random_state=j)
    y_test = shuffle(y, random_state=j).iloc[2000:4000]
    ...
    # X_train_full, X_test, y_train_full, y_test = train_test_split(X, y, test_size=0.15, random_state=j)
    ...
    # %%
    # X_test_green, X_train_green, y_test_green, y_train_green = train_test_split(X_green, y_green, test_size=1, random_state=j)
